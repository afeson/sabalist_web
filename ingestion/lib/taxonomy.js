...
// Subs MUST mirror src/config/categories.js exactly — VALID_SUBS (below) is
// derived from these arrays and the pipeline rejects any subcategory not in the
// set. Keep this list in 1:1 sync with the canonical taxonomy.
const CATEGORIES = [
  { id: 'real-estate', label: 'Real Estate',
    subs: ['houses-sale', 'houses-rent', 'apartments', 'land', 'commercial-property', 'short-let'],
  ...
  { id: 'electronics', label: 'Electronics',
    subs: ['tvs', 'audio-speakers', 'cameras', 'gaming-consoles', 'smart-devices', 'wearables', 'accessories'],
  ...
  { id: 'phones-tablets', label: 'Phones & Tablets',
    subs: ['smartphones', 'feature-phones', 'tablets', 'phone-accessories', 'sim-cards'],
    keywords: ['phone', 'smartphone', 'iphone', 'samsung galaxy', 'tablet', 'ipad', 'android'] },
  { id: 'computers', label: 'Computers',
    subs: ['laptops', 'desktops', 'components', 'printers', 'networking', 'software'],
    keywords: ['laptop', 'desktop', 'computer', 'pc', 'macbook', 'monitor', 'keyboard', 'router'] },
  { id: 'fashion', label: 'Fashion',
    subs: ['mens-clothing', 'womens-clothing', 'shoes', 'bags', 'accessories', 'watches-jewelry', 'traditional-wear'],
    keywords: ['clothing', 'dress', 'shirt', 'shoes', 'sneaker', 'bag', 'handbag', 'watch', 'jewelry', 'fashion'] },
  { id: 'beauty', label: 'Beauty',
    subs: ['skincare', 'makeup', 'haircare', 'fragrances', 'beauty-tools'],
    keywords: ['beauty', 'makeup', 'skincare', 'cosmetic', 'perfume', 'wig', 'hair'] },
  { id: 'home-furniture', label: 'Home & Furniture',
    subs: ['sofas-chairs', 'beds-mattresses', 'tables-desks', 'wardrobes', 'kitchen', 'decor', 'home-appliances', 'office-furniture'],
  ...
  { id: 'services', label: 'Services',
    subs: ['cleaning', 'electrical', 'plumbing', 'graphic-design', 'tutoring', 'photography', 'beauty-services'],
    keywords: ['service', 'cleaning', 'plumber', 'electrician', 'repair', 'tutor', 'design', 'consulting'] },
  { id: 'agriculture', label: 'Agriculture',
    subs: ['crops', 'seeds', 'fertilizers', 'farm-equipment', 'livestock-feed'],
    keywords: ['farm', 'agriculture', 'crop', 'tractor', 'seed', 'harvest', 'fertilizer', 'produce'] },
  { id: 'animals-pets', label: 'Animals & Pets',
    subs: ['dogs', 'cats', 'birds', 'livestock', 'pet-accessories', 'pet-food'],
  ...
  { id: 'business-industrial', label: 'Business & Industrial',
    subs: ['office-equipment', 'machinery', 'wholesale', 'industrial-tools'],
  ...
  { id: 'sports-fitness', label: 'Sports & Fitness',
    subs: ['gym-equipment', 'cycling', 'outdoor', 'team-sports', 'sports-apparel'],
    keywords: ['gym', 'fitness', 'stadium', 'sports', 'football', 'workout'] },
  { id: 'rentals', label: 'Rentals',
    subs: ['equipment-rentals', 'car-rentals', 'property-rentals', 'event-rentals'],
    keywords: ['for rent', 'to let', 'rental', 'apartment', 'short let', 'bedroom flat'] },
  { id: 'entertainment', label: 'Entertainment',
    subs: ['music', 'movies', 'games', 'instruments', 'art-collectibles'],
    keywords: ['cinema', 'theatre', 'theater', 'nightclub', 'arts centre', 'entertainment'] },
  { id: 'community', label: 'Community',
    subs: ['lost-found', 'free-items', 'volunteers', 'announcements'],
    keywords: ['community centre', 'church', 'mosque', 'temple', 'library', 'community'] },
  { id: 'construction', label: 'Construction',
    subs: ['building-materials', 'cement-mixers', 'generators', 'excavators', 'power-tools', 'drilling-machines'],
    keywords: ['construction', 'hardware', 'building materials', 'cement', 'contractor'] },
  { id: 'repair-services', label: 'Repair Services',
    subs: ['car-repair', 'phone-repair', 'appliance-repair', 'plumbing-repair', 'electrical-repair'],
